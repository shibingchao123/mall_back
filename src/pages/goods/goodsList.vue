<template>
    <transition name="el-fade-in">
            <div>
                <div class="head">
                    <span style="flex-basis:92%">
                        <el-breadcrumb separator-class="el-icon-arrow-right" >
                        <el-breadcrumb-item>商品管理</el-breadcrumb-item>
                        <el-breadcrumb-item>商品列表</el-breadcrumb-item>
                    </el-breadcrumb>
                    </span>
                   <span style="flex-basis: 8%">
            ...
            <div class="tableT clearfix">
                <div class="f-r m-r-10">
                    <el-select @change="requireData(1)" size="mini" v-model="pageType.pageSize" placeholder="显示条数">
                        <el-option
                ...
                <div class="f-r m-r-10">
                    <el-button size="small" @click="onAll()">批量上架</el-button>
                    <el-button size="small" @click="upAll()">批量下架</el-button>
                        ...
                        <template slot-scope="scope">
                            <div>
                                ...
                                <el-button @click="del(scope.row.commodityId)" type="text" size="small" >删除</el-button>
                                 <div>
                                    <el-button type="text" size="small" @click="GoOnline(scope.row.commodityId,1)">上移</el-button>
                                    <el-button type="text" size="small" @click="GoOnline(scope.row.commodityId,2)">下移</el-button>
                                    <el-button type="text" size="small" @click="goTop(scope.row.commodityId,1)">置顶</el-button>
                                    <el-button type="text" size="small" @click="goBottom(scope.row.commodityId,2)">置底</el-button>
                                </div>
                                <!--<div>-->
                                    <!--<el-button type="text" size="small" @click="edit(scope.row,2)">复制商品</el-button>-->
                                <!--</div>-->
                            </div>
                        </template>
                    </el-table-column>
            ...
            <!--查看弹窗-->
                ...
                <el-dialog
                    ...
                    <div v-if="editDialogVisible">
                        <reGoods :editTable="editTable" :copyNum="copyNum" @close="closeEdit"></reGoods>
                    </div>
                    <span slot="footer" class="dialog-footer">
...
<script>
    ...
    export default {
        ...
        created() {
            let a = this.$route.query.activity_code;
            console.log(a);
            if (a) {
                console.log('跳转来的');
        ...
        methods: {
            GoOnline(val,num){
                this._ajax('admin/updateCommoditySort',
                    {
                        commodityId: val,
                        move: num
                    }
            ...
            //置顶
            goTop(val,num){
                this._ajax('admin/updateCommodityTop',
                    {
                        commodityId: val,
                        move: num
                    }
            ...
            //置底
            goBottom(val,num){
                this._ajax('admin/updateCommodityButtom',
                    {
                        commodityId: val,
                        move: num
                    }
            ...
            onAll(){
                ...
                },{logAdmin:this.bear.adminId,logCustomer:this.goodsId})
            },
            //批量下架
            upAll(){
            ...
            outline(row) {
                this.$confirm('确定下架?', '提示', {
                    ...
                    this._ajax('admin/updateCommodityOff', {
                        ...
                        this.requireData(this.pageType.page);
                    },{logAdmin:this.bear.adminId,logCustomer:row});
            ...
            del(i){
                this.$confirm('此操作将删除该文件, 是否继续?', '提示', {
                    ...
                    this._ajax('admin/updateCommodityDel', {
                        ...
                        this.requireData(this.pageType.page);
                    },{logAdmin:this.bear.adminId,logCustomer:i});
