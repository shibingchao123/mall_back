    ...
    <transition name="el-fade-in">
        <div>
            <TableHeader
                ref="tableHeader"
                :showoption="['crumbs']"
                :breadcrumb="{nameA: '用户管理', nameB: '包裹记录打印'}">
            </TableHeader>
            <div class="banner2">
            ...
            <!-- 表格展示区 -->
            <div :style="{'width': '100%', 'height': (screenHeight - 220) + 'px'}" class="table-box">
                <!-- 表格 -->
                <el-table
                    :data="tableData"
                    height="100%"
...
<script>
    ...
    // dayin
    import orderHistory2 from '../userManagement/orderHistory2'
    ...
    export default {
        ...
        methods: {
            ...
            leadingOut(){
                ...
                if (this.chooseList.length == 0) {
                    ...
                    this._ajax('admin/getMerchantOrderByCount', this.topData, msg => {
                        console.log(msg);
        ...
        components: {
            TableHeader, orderHistory2
            // merchantMsg, orderHistory,orderHistory2
        },
        mixins: [mixin],
        created() {
            this.requireData(1);
